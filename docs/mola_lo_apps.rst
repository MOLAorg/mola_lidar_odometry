...
-------------------------------
    ...
    .. code-block:: text
        ...
        mola-lidar-odometry-cli [OPTIONS]

        OPTIONS:
          -h,     --help              Print this help message and exit
                  --version           Display program version information and exit
          -c,     --config TEXT REQUIRED
                                      Input pipeline YAML config file (required) (*.yml)
          -v,     --verbosity TEXT    Verbosity level: ERROR|WARN|INFO|DEBUG {Default: INFO}
          -l,     --load-plugins foobar.so
                  ...
                  --imu-sensor-label TEXT [imu]
                                      ...
                                      {std::regex}
                  --base-link-frame-id TEXT [base_link]
                                      Only for rosbag input sources. This defines the /tf frame_id used
                                      as reference frame for the vehicle or robot. It is used to get
                                      sensors poses with respect to the vehicle from /tf data.
                  --tf-topic TEXT [/tf]
                                      Only for rosbag2 input: /tf topic name in the bag. Override for
                                      namespaced bags (e.g. '/robot1/tf').
                  --tf-static-topic TEXT [/tf_static]
                                      Only for rosbag2 input: /tf_static topic name in the bag.
                                      Override for namespaced bags (e.g. '/robot1/tf_static').
                  --progress-bar-period FLOAT:FLOAT in [0 - 100]
                                      Minimum percentage step, in [0,100], between progress bar
                                      printouts. Use 0 to disable the progress bar entirely. Handy to
                                      cut down log verbosity in batch/CI runs (e.g. Jenkins). {Default:
                                      print on (almost) every processed entry}
